...
python3 ./test/test.py --nw hrnet --task single --cp /home/groups/noh/icshm_data/valid_checkpoints_cmp/hrnet/0/ --dr DATA_ROOT --split_csv $DATA_ROOT/splits/train_dmg0.txt --save_path $DATA_ROOT/code_test/cmp_train_dmg --img_dir img_syn_raw/train_resize --ann_dir synthetic/train_labcmp --split splits/train_dmg0.txt --slide --type cmp --width 640 --height 360
