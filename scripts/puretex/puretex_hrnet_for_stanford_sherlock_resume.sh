...
python3 -m torch.distributed.launch --nproc_per_node=2 --master_port=$RANDOM train_3classes_puretex.py --nw hrnet --cp ~/research/icshm/ic-shm2021-p1/configs/hrnet/fcn_hr48_512x1024_40k_cityscapes.py --bs 16 --distributed --multi_loss --ohem --job_name hrnet_puretex --resume_from /home/groups/noh/icshm_data/checkpoints/puretex/hrnet_puretex_hrnet_20220115-161215_hrnet/latest.pth 