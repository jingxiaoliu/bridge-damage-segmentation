...
python3 -m torch.distributed.launch --nproc_per_node=2 --master_port=$RANDOM train_3classes_puretex.py --nw swin --cp ~/research/icshm/ic-shm2021-p1/configs/swin/upernet_swin_base_patch4_window12_512x512_160k_ade20k_pretrain_384x384_22K.py --bs 8 --distributed --multi_loss --ohem --job_name swin_puretex --resume_from /home/groups/noh/icshm_data/checkpoints/puretex/swin_puretex_swin_20220116-051926_swin/latest.pth