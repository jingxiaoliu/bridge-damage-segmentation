...
python3 -m torch.distributed.launch --nproc_per_node=2 --master_port=$RANDOM train_3classes_puretex.py --nw pspnet --cp ~/research/icshm/ic-shm2021-p1/configs/pspnet/pspnet_r101b-d8_512x1024_80k_cityscapes.py --bs 16 --distributed --multi_loss --ohem --job_name pspnet_puretex --resume_from /home/groups/noh/icshm_data/checkpoints/puretex/pspnet_puretex_pspnet_20220117-213137_pspnet/latest.pth