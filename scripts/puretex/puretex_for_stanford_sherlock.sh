...
python3 -m torch.distributed.launch --nproc_per_node=2 --master_port=$RANDOM train_3classes_puretex.py --nw resnest --cp ~/research/icshm/ic-shm2021-p1/configs/resnest/deeplabv3_s101-d8_512x1024_80k_cityscapes.py --bs 2 --distributed --multi_loss --ohem --job_name resnest_puretex