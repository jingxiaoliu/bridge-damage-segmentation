...
python3 -m torch.distributed.launch --nproc_per_node=2 --master_port=$RANDOM train_3classes_for_stanford_sherlock.py --nw ocrnet --cp ~/research/icshm/ic-shm2021-p1/configs/ocrnet/ocrnet_hr48_512x1024_40k_cityscapes.py --bs 16 --distributed --multi_loss --ohem --job_name ocrnet_ohem$1 --split_id $1
