...
python3 -m torch.distributed.launch --nproc_per_node=2 --master_port=$RANDOM train_3classes_for_stanford_sherlock.py --nw pspnet --cp ~/research/icshm/ic-shm2021-p1/configs/pspnet/pspnet_r101b-d8_512x1024_80k_cityscapes.py --bs 16 --distributed --multi_loss --ohem --job_name pspnet_ohem$1 --split_id $1
