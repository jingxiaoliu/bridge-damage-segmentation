...
python3 -m torch.distributed.launch --nproc_per_node=2 --master_port=$RANDOM train_8classes_for_stanford_sherlock.py --nw hrnet --cp ~/research/icshm/ic-shm2021-p1/configs/hrnet/fcn_hr48_512x1024_40k_cityscapes.py --bs 16 --distributed --multi_loss --ohem --job_name hrnet_ohem$1 --split_id $1 --resume_from /home/groups/noh/icshm_data/checkpoints/augcmp/0/hrnet_ohem0_hrnet_20220115-171015_hrnet/latest.pth
