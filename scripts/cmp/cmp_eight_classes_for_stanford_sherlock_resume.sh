...
python3 -m torch.distributed.launch --nproc_per_node=2 --master_port=$RANDOM train_8classes_for_stanford_sherlock.py --nw resnest --cp ~/research/icshm/ic-shm2021-p1/configs/resnest/deeplabv3_s101-d8_512x1024_80k_cityscapes.py --bs 8 --distributed --multi_loss --ohem --job_name resnest_ohem$1 --split_id $1 --resume_from /home/groups/noh/icshm_data/checkpoints/augcmp/0/resnest_ohem0_resnest_20220114-101526_resnest/latest.pth