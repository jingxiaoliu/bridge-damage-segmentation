...
# hrnet
python3 ./test/test.py --nw hrnet --task single --cp $DATA_ROOT/valid_checkpoints_cmp/hrnet/0/ --dr $DATA_ROOT --split_csv $DATA_ROOT/splits/test_dmg.txt --save_path $DATA_ROOT/dmg_test --img_dir img_syn_raw/test --ann_dir synthetic/labdmg --split splits/test_dmg.txt --type dmg --width 1920 --height 1080 --slide
# pspnet
python3 ./test/test.py --nw pspnet --task single --cp $DATA_ROOT/valid_checkpoints_cmp/pspnet/0/ --dr $DATA_ROOT --split_csv $DATA_ROOT/splits/test_dmg.txt --save_path $DATA_ROOT/dmg_test --img_dir img_syn_raw/test --ann_dir synthetic/labdmg --split splits/test_dmg.txt --type dmg --width 1920 --height 1080 --slide
# ocrnet
python3 ./test/test.py --nw ocrnet --task single --cp $DATA_ROOT/valid_checkpoints_cmp/ocrnet/0/ --dr $DATA_ROOT --split_csv $DATA_ROOT/splits/test_dmg.txt --save_path $DATA_ROOT/dmg_test --img_dir img_syn_raw/test --ann_dir synthetic/labdmg --split splits/test_dmg.txt --type dmg --width 1920 --height 1080 --slide
# resnest
python3 ./test/test.py --nw resnest --task single --cp $DATA_ROOT/valid_checkpoints_cmp/resnest/0/ --dr $DATA_ROOT --split_csv $DATA_ROOT/splits/test_dmg.txt --save_path $DATA_ROOT/dmg_test --img_dir img_syn_raw/test --ann_dir synthetic/labdmg --split splits/test_dmg.txt --type dmg --width 1920 --height 1080 --slide
# swin
python3 ./test/test.py --nw swin --task single --cp /home/groups/noh/icshm_data/valid_checkpoints_cmp/swin/0/ --dr $DATA_ROOT --split_csv $DATA_ROOT/splits/test_dmg.txt --save_path $DATA_ROOT/dmg_test --img_dir img_syn_raw/test --ann_dir synthetic/labdmg --split splits/test_dmg.txt --type dmg --width 1920 --height 1080 --slide
# ensemble learning
# Change subsets starting and ending numbers for cross validation
