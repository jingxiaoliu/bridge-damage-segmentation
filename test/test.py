...
parser.add_argument("--img_dir", type=str, required=True, help="Image file directory.")
parser.add_argument("--ann_dir", type=str, required=True, help="Label directory.")
parser.add_argument("--split", type=str, required=True, help="Split file in root.")
